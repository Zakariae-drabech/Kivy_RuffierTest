# -*- coding: utf-8 -*-
"""
Created on Mon Oct 30 19:51:16 2023
...
from kivy.uix.screenmanager import (ScreenManager, Screen,
                                     WipeTransition, ShaderTransition,
                                     SlideTransition, CardTransition,
...
from LabelAnimmation import AnimLabel
#from kivy.uix.popup import Popup
#popup = Popup(title='Window title', 
#  content=Label(text='Popup text'))
#popup.open()


Window.clearcolor = (.87, 0.54, 0.8, 0.3)
btn_color = (0.98, 0.31, 0.8, 0.9)
...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = Label(text=txt_instruction, halign='left',pos_hint={'x': 0.05 })
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn_back = Button(text='Back', size_hint=(0.3, 0.4), pos_hint={'center_x': 0.5})
        self.btn_back.background_color = btn_color
        self.btn_back.on_press = self.back_fun

        Box_Btn = BoxLayout(orientation='horizontal', padding=8, spacing=8)
        Box_Btn.add_widget(self.btn_back)
        Box_Btn.add_widget(self.btn)
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        ...
        instr = Label(text=txt_sits)#, pos_hint={'x': 0.2 })
        self.lbl_sits = Sits(30)
        self.run = Runner(total=30, steptime=1.5, size_hint=(0.1, 1))
        ...
        self.btn_back = Button(text='Back', size_hint=(0.3, 0.2), pos_hint={'center_x': 0.5})
        self.btn_back.background_color = btn_color
        self.btn_back.on_press = self.back_fun
        Box_Btn = BoxLayout(orientation='horizontal', padding=8, spacing=8)
        Box_Btn.add_widget(self.btn_back)
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.lbl_sec = Seconds(15)
        self.lbl_sec.bind(done=self.sec_finished)
        self.lbl1 = AnimLabel(text='Calculate your heart rate',total=60, steptime=1)
        ...
        self.btn_back = Button(text='Back', size_hint=(0.3, 0.5), pos_hint={'center_x': 0.5})
        self.btn_back.background_color = btn_color
        self.btn_back.on_press = self.back_fun
        Box_Btn = BoxLayout(orientation='horizontal', padding=8, spacing=8)
        Box_Btn.add_widget(self.btn_back)
...
class Result(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn_end = Button(text='End', size_hint=(0.3, 0.2), pos_hint={'center_x': 0.5})
        self.btn_end.background_color = btn_color
        self.btn_end.on_press = self.end_fun
        ...
        Box_Btn = BoxLayout(orientation='horizontal', padding=8, spacing=8)
        Box_Btn.add_widget(self.btn_back)
        Box_Btn.add_widget(self.btn_end)

        self.outer.add_widget(self.instr)
        self.add_widget(Box_Btn)
